...
uintptr_t handle_trap(uintptr_t mcause, uintptr_t mepc, uintptr_t sp)
{
    ...
    {
        // Arguments supplied to this method are mcause, mepc (exception PC) and stack pointer
        ...
        uintptr_t mbadaddr = read_csr(mbadaddr); // additional info and meaning depends on mcause (new name is mtval)
